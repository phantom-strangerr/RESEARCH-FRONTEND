  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-sm text-slate-900 dark:text-white">Devices</span>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-gray-500">/</span>
        <span className="text-sm text-slate-900 dark:text-white">Alerts</span>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-gray-500">/</span>
        <span className="text-sm text-slate-900 dark:text-white">Metrics</span>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-gray-500">/</span>
        <span className="text-sm text-slate-900 dark:text-white">Logs</span>
      </div>
