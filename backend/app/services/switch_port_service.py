...
def seed_ports(db: Session):
    sample_ports = [
        ...
        {"port_number": 5, "status": "isolated", "device_ip": "192.168.1.108", "device_mac": "FF:EE:DD:CC:BB:AA", "device_name": "Camera-05", "vlan": 30, "speed": "100M", "bytes_sent": 10.3, "bytes_received": 8.5, "errors": 67, "drops": 34, "isolation_reason": "Mirai Activity detected", "isolated_by": "edge_ml"},
